...
private:
	void ConvertToShader::conv420toFloatRGB(const byte *py, const byte *pu, const byte *pv, unsigned char *dst, int pitch1Y, int pitch1UV, int pitch2, int width, int height);
